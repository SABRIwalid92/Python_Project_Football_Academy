...
class Offer: 
    ...
    @classmethod
    def create(cls, data):
            query = """INSERT INTO offers (position, age, weight, height, skills, trainer_id, scout_id)
                                    VALUES(%(position)s, %(age)s, %(weight)s, %(height)s, %(skills)s, %(trainer_id)s, %(scout_id)s);"""
